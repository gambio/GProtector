...
$this->add_filter(
    'Alphanumerisch-Filter 1',
    'admin/products_attributes.php',
    '_GET["option_order_by"]',
    'only_alphanumeric'
);
$this->add_filter(
    'Alphanumerisch-Filter 2',
    [
...
$this->add_filter(
    'htmlentities-Filter 1',
    'admin/gv_mail.php',
    ['_POST["email_to"]', '_GET["mail_sent_to"]'],
    'htmlentities'
);
$this->add_filter(
    'htmlentities-Filter 2',
    'admin/mail.php',
...
$this->add_filter(
    'Rekursiv-Alphanumerisch-Filter 1',
    'admin/accounting.php',
    '_POST["access"]',
    'recursive_only_alphanumeric'
);
$this->add_filter(
    'Rekursiv-Alphanumerisch-Filter 2',
    'admin/stats_sales_report.php',
    '_GET["orders_status"]',
    'recursive_only_alphanumeric'
);
...
$this->add_filter(
    'Rekursiv-htmlspecialchars-Filter 1',
    'admin/gm_feature_control.php',
    '_POST["featAdminName"]',
    'recursive_htmlspecialchars'
);
$this->add_filter(
    'Rekursiv-htmlspecialchars-Filter 2',
    'admin/gm_feature_control.php',
    '_POST["featName"]',
    'recursive_htmlspecialchars'
);
$this->add_filter(
    'Rekursiv-htmlspecialchars-Filter 3',
    'admin/gm_feature_control.php',
    '_POST["featNew"]',
    'recursive_htmlspecialchars'
);
$this->add_filter(
    'Rekursiv-htmlspecialchars-Filter 4',
    'admin/gm_feature_control.php',
    '_POST["featValueNew"]',
    'recursive_htmlspecialchars'
);
$this->add_filter(
    'Rekursiv-htmlspecialchars-Filter 5',
    'admin/request_port.php',
    '_POST["values_name"]',
    'recursive_htmlspecialchars'
);
...
$this->add_filter(
    'htmlspecialchars-Filter 2',
    ['admin/request_port.php'],
    ['_POST["value_model"]'],
    'htmlspecialchars'
);
$this->add_filter(
    'htmlspecialchars-Filter 3',
    [
        'login.php',
        'shop.php'
    ],
